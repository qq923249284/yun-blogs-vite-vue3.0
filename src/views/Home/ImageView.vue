...
(function () {
  ...
  helixLayout = (_) => {
    ...
    $("#box li").each((i) => {
      ...
      $("#box li")
        .eq(arr[idx])
        .css({
          transform: `rotateY(${liElemDegY}deg) translateY(${liElemDepY}px) translateZ(${Math.abs(
            liElemDepDefault
          )}px)`,
          transition: "4s ease-in-out",
        });
  ...
  sphereLayout = (_) => {
    ...
    $("#box li").each((i) => {
      ...
      $("#box li")
        .eq(arr[idx])
        .css({
          transform: `rotateY(${liElemDegY}deg) rotateX(${liElemDegX}deg) translateZ(${Math.abs(
            liElemDepDefault
          )}px)`,
          transition: "4s ease-in-out",
        });
  ...
  function main() {
    $([...Array(liElemMaxNum).keys()]).each((i) => {
      ...
      spanElem.css(
        "color",
        `rgb(${randomFrom(100, 255)},${randomFrom(100, 255)},${randomFrom(
          100,
          255
        )})`
      );
